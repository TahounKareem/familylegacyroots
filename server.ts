...
- التكلفة الأساسية للإصدار تختلف حسب نظام الدفع (بالدولار الأمريكي USD):
  1. السداد المبكر بالكامل: دفعة واحدة قيمتها 1780 دولار.
  2. الدفع المرن: إجمالي 1980 دولار (مقسمة على 3 دفعات، الدفعة الأولى 693 دولار).
