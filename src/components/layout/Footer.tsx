      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-[#A0A2A3] flex flex-col items-center gap-6 text-sm text-white">
          ...
          <div className="flex flex-wrap gap-4 items-center justify-center">
            {/* Facebook */}
            <a href="https://www.facebook.com/TheFamilyLegacyRoots" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-brand-500 hover:border-brand-500 hover:text-white transition shadow-sm">
            ...
            {/* X (Twitter) */}
            <a href="https://x.com/TFamilyLegacy" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-brand-500 hover:border-brand-500 hover:text-white transition shadow-sm">
            ...
            {/* TikTok */}
            <a href="https://www.tiktok.com/@TheFamilyLegacyRoots" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-brand-500 hover:border-brand-500 hover:text-white transition shadow-sm" title="TikTok">
            ...
            {/* Snapchat */}
            <a href="https://www.snapchat.com/@TheFamilyLegacy" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-brand-500 hover:border-brand-500 hover:text-white transition shadow-sm">
