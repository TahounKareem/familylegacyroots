            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-brand-100 sticky top-8 z-50">
              ...
              <div className="mt-8 pt-6">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  ...
                  {/* Instagram */}
                  <a href="https://www.instagram.com/TheFamilyLegacyRoots" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-full bg-brand-50 border border-brand-100 flex items-center justify-center text-brand-600 hover:bg-brand-600 hover:text-white transition shadow-sm" title="Instagram">
                  ...
                  {/* X (Twitter) */}
                  <a href="https://x.com/TFamilyLegacy" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-full bg-brand-50 border border-brand-100 flex items-center justify-center text-brand-600 hover:bg-brand-600 hover:text-white transition shadow-sm" title="X (Twitter)">
                  ...
                  {/* TikTok Roots */}
                  <a href="https://www.tiktok.com/@TheFamilyLegacyRoots" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-full bg-brand-50 border border-brand-100 flex items-center justify-center text-brand-600 hover:bg-brand-600 hover:text-white transition shadow-sm" title="TikTok">
