               ...
               <div className="w-full bg-[#f8f9fa] rounded-2xl p-4 shadow-inner border border-gray-200 flex flex-col items-center justify-center relative min-h-[500px]">
                 {isLoadingUrl ? (
                   ...
                   <div className="flex flex-col items-center justify-center p-6 text-center">
                     ...
                     <div className="bg-brand-50 text-brand-800 p-4 rounded-xl text-sm w-full max-w-lg text-right border border-brand-100">
                       <h4 className="font-bold mb-2 text-brand-900">كيف يمكنني حل المشكلة؟</h4>
                       <ul className="list-disc pr-5 space-y-2">
                         <li>رمز المصادقة (Token) الخاص بـ SignNow تنتهي صلاحيته كل 30 يوماً.</li>
                         <li>المحاولة التلقائية لتجديد الرمز فشلت بسبب أن كلمة المرور أو الإيميل غير متطابقة (تأكد من <code>SIGNNOW_PASSWORD</code>). أو بسبب تفعيل المصادقة الثنائية 2FA على حسابك.</li>
                         <li><strong>لحل المشكلة نهائياً:</strong> قم بالدخول لحسابك في SignNow (Developer Console) وتوليد <code>Personal Access Token</code> جديد يدوياً، وثبّته في إعدادات البيئة تحت اسم <code>SIGNNOW_API_KEY</code>.</li>
                       </ul>
                     </div>
                   </div>
                 )}
